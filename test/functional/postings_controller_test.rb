...
class PostingsControllerTest < ActionController::TestCase
  ...
  test "should create posting" do
    assert_difference('Posting.count') do
      post :create, posting: { image: @posting.image, post: @posting.post, post_on: @posting.post_on, user_id: @posting.user_id, video: @posting.video }
    end
  ...
  test "should update posting" do
    put :update, id: @posting, posting: { image: @posting.image, post: @posting.post, post_on: @posting.post_on, user_id: @posting.user_id, video: @posting.video }
    assert_redirected_to posting_path(assigns(:posting))
  end
